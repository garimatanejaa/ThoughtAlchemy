...
import { analyzeIdeaEvolution } from './ideaEvolutionService.js';
...
/**
 * Save idea with AI-generated evolution mapping
 */
export const saveIdeaWithEvolution = async (userId, originalA, finalText, type, originalB = null) => {
  const evolutionData = await analyzeIdeaEvolution(finalText, originalA, originalB);
  ...
  const idea = new Idea({
    ...
    blendedWith: originalB || undefined,
    dnaMapping: evolutionData
  });
